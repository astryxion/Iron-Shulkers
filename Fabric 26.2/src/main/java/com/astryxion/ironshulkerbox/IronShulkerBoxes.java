...
public class IronShulkerBoxes implements ModInitializer, DataGeneratorEntrypoint {
  ...
  public void onInitialize() {
    PayloadTypeRegistry.clientboundPlay().register(TopStacksSyncPacket.TYPE, TopStacksSyncPacket.STREAM_CODEC);
    ...
    CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.IRON_SHULKER_BOX.asItem(), SHULKER_BOX);
    CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.GOLD_SHULKER_BOX.asItem(), SHULKER_BOX);
    CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.DIAMOND_SHULKER_BOX.asItem(), SHULKER_BOX);
    CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.COPPER_SHULKER_BOX.asItem(), SHULKER_BOX);
    CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.CRYSTAL_SHULKER_BOX.asItem(), SHULKER_BOX);
    CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.OBSIDIAN_SHULKER_BOX.asItem(), SHULKER_BOX);

    for (DyeColor color : DyeColor.values()) {
      CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.IRON_SHULKER_BOXES.get(color).asItem(), SHULKER_BOX);
      CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.GOLD_SHULKER_BOXES.get(color).asItem(), SHULKER_BOX);
      CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.DIAMOND_SHULKER_BOXES.get(color).asItem(), SHULKER_BOX);
      CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.COPPER_SHULKER_BOXES.get(color).asItem(), SHULKER_BOX);
      CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.CRYSTAL_SHULKER_BOXES.get(color).asItem(), SHULKER_BOX);
      CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.OBSIDIAN_SHULKER_BOXES.get(color).asItem(), SHULKER_BOX);

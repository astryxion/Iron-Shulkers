...
public class IronShulkerBoxesRecipes {
  ...
  public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<IronShulkerBoxCraftingRecipe>> SHULKER_BOX_CRAFTING = RECIPE_SERIALIZERS.register("shulker_box_crafting", IronShulkerBoxCraftingRecipe.Serializer::new);
}

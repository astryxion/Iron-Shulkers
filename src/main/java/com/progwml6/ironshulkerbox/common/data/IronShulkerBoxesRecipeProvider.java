...
public class IronShulkerBoxesRecipeProvider extends FabricRecipeProvider {
  ...
  public IronShulkerBoxesRecipeProvider(FabricDataOutput output) {
    super(output);
  }
  ...
  private void addColoredShulkerBoxRecipes(Consumer<FinishedRecipe> output) {
  ...
  private void addUpgradesRecipes(Consumer<FinishedRecipe> output) {
  ...
  private void registerCopperBoxRecipe(Consumer<FinishedRecipe> output, ItemLike result, ItemLike input, String color, String group) {
  ...
  private void registerIronBoxRecipe(Consumer<FinishedRecipe> output, ItemLike result, ItemLike input, ItemLike inputTwo, String color, String group) {
    ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, result)
      .group(group)
      .define('G', GLASS_BLOCKS)
      .define('S', input)
  ...
  private void registerGoldBoxRecipe(Consumer<FinishedRecipe> output, ItemLike result, ItemLike input, String color, String group) {
    ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, result)
      .group(group)
      .define('S', input)
      .define('M', GOLD_INGOTS)
  ...
  private void registerDiamondBoxRecipe(Consumer<FinishedRecipe> output, ItemLike result, ItemLike input, String color, String group) {
    ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, result)
      .group(group)
      .define('G', GLASS_BLOCKS)
      .define('S', input)
  ...
  private void registerCrystalBoxRecipe(Consumer<FinishedRecipe> output, ItemLike result, ItemLike input, String color, String group) {
    ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, result)
      .group(group)
      .define('G', GLASS_BLOCKS)
      .define('S', input)
  ...
  private void registerObsidianBoxRecipe(Consumer<FinishedRecipe> output, ItemLike result, ItemLike input, String color, String group) {
    ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, result)
      .group(group)

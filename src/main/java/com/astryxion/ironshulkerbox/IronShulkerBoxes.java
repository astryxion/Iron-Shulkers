...
public class IronShulkerBoxes {
  ...
  private void setup(final FMLCommonSetupEvent event) {
    event.enqueueWork(() -> {
      ...
      CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.IRON_SHULKER_BOX.get().asItem(), SHULKER_BOX);
      CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.GOLD_SHULKER_BOX.get().asItem(), SHULKER_BOX);
      CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.DIAMOND_SHULKER_BOX.get().asItem(), SHULKER_BOX);
      CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.COPPER_SHULKER_BOX.get().asItem(), SHULKER_BOX);
      CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.CRYSTAL_SHULKER_BOX.get().asItem(), SHULKER_BOX);
      CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.OBSIDIAN_SHULKER_BOX.get().asItem(), SHULKER_BOX);

      for (DyeColor color : DyeColor.values()) {
        CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.IRON_SHULKER_BOXES.get(color).get().asItem(), SHULKER_BOX);
        CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.GOLD_SHULKER_BOXES.get(color).get().asItem(), SHULKER_BOX);
        CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.DIAMOND_SHULKER_BOXES.get(color).get().asItem(), SHULKER_BOX);
        CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.COPPER_SHULKER_BOXES.get(color).get().asItem(), SHULKER_BOX);
        CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.CRYSTAL_SHULKER_BOXES.get(color).get().asItem(), SHULKER_BOX);
        CauldronInteractions.WATER.put(IronShulkerBoxesBlocks.OBSIDIAN_SHULKER_BOXES.get(color).get().asItem(), SHULKER_BOX);
